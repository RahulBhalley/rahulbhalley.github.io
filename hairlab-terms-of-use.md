---
layout: page
title: "HairLab Terms of Use"
permalink: /hairlab-terms-of-use/
---
...
If you download HairLab through Apple's App Store, Apple's [Licensed Application End User License Agreement](https://www.apple.com/legal/internet-services/itunes/dev/stdeula/) ("Apple Standard EULA") also applies unless a custom license is presented through the App Store. These Terms supplement the applicable Apple terms. Mandatory Apple terms and applicable consumer laws control if they conflict with these Terms.
...
You grant HairLab and the service providers used by HairLab a non-exclusive, worldwide, royalty-free license to host, transmit, reproduce, modify, and process your submitted content only as reasonably necessary to provide, secure, troubleshoot, and operate the requested feature, subject to the [HairLab Privacy Policy](/hairlab-privacy-policy/).

Cloud edits are provided through Perfect Corp. Your submission and the generated result may also be governed by Perfect Corp.'s applicable [YouCam API Terms](https://www.perfectcorp.com/perfectbeauty/youcam/terms-of-service-api) and [YouCam SaaS Privacy Policy](https://www.perfectcorp.com/business/privacy). You should review those documents before using a cloud edit.
